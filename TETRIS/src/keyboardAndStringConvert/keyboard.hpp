 ...
 * binaire retournée.
 *
 * Le modèle de fonction utilise he2b::esi::dev4::fromString(), donc l'opérateur
 ...
 *
 * \exception he2b::esi::dev4::bad_string_convert Outre les exceptions qui pourraient
 ...
 *                  car he2b::esi::dev4::fromString() est utilisée.
 */
template<typename T>
